...
<div class="jumbotron text-light" style="background-image: url('https://source.unsplash.com/1600x900/?nature')">
    <div class="container">
        <h1 class="display-3">Tax Compliance made easy.</h1>
        ...
        <a href="/login" class="btn btn-success btn-lg my-2">Sign Up for Access to Your Vehicles</a>             
    </div>
</div>
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Manage all your vehicle tax in one place</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Check and manage with the click of a button</p>
                </div>
            </div>
        </div>
    </div>
